	...
	<body>
 	...
 	<div class="content">
        ...
        <table class="tableRida">
          <tr class="trRA">
              <th class="thReda thAsri"><h2 class="mb-7">List Client</h2></th>
              ...
              <th class="thReda thAsri"></th>
              <th class="thReda thAsri"></th>
              <th class="thReda thAsri">  <form class="d-flex" action="Inscription.jsp">
           <button class="btn btn-outline-dark" type="submit" >
            ...
            <tr class="trRA">
                ...
                <th class="thReda thAsri">Prenom</th>
                <th class="thReda thAsri">Références</th>
                <th class="thReda thAsri">Ville</th>
                <th class="thReda thAsri">Tel</th>
                <th class="thReda thAsri">Pays</th>
                <th class="thReda thAsri">Code Postal</th>
                <th class="thReda thAsri">Adresse</th>
                <th class="thReda thAsri">Email</th>
                <th class="thReda thAsri">ID Panier</th>
                <th class="thReda thAsri">Login</th>
                <th class="thReda thAsri">Password</th>
            ...
            List<Client> C = em.createQuery("from Client c").getResultList();
        
            for(int i=0;i<C.size();i++){
            %>
      <tr class="trRA">
      <td class="tdReda"><%=C.get(i).getNom()%></td>
      <td class="tdReda"><%=C.get(i).getPrenom()%></td>
      <td class="tdReda"><%=C.get(i).getRefClient()%></td>
      <td class="tdReda"><%=C.get(i).getVille()%></td>
      <td class="tdReda"><%=C.get(i).getTel()%></td>
      <td class="tdReda"><%=C.get(i).getPays()%></td>
      <td class="tdReda"><%=C.get(i).getCodePostal()%></td>
      <td class="tdReda"><%=C.get(i).getAdresse()%></td>
      <td class="tdReda"><%=C.get(i).getEmail()%></td>
      <td class="tdReda"><%=C.get(i).getPanier().getId_Panier()%></td>
      <td class="tdReda"><%=C.get(i).getLogin()%></td>
      <td class="tdReda"><%=C.get(i).getMotDepasse()%></td>
      </tr>
      <% 
         }
